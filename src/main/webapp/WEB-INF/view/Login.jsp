  ...
  <body class="skin-blue">
    <div class="wrapper">
       <header class="main-header">
        <!-- Logo -->
        <a href="login" class="logo"><b></b>Document Tracking</a>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
			<h1>Login</h1>
			<ol class="breadcrumb">
	            <li><a href="login"><i class="fa fa-dashboard"></i> Main</a></li>
	...
	<div class="Center row">
		<div class="col-md-6">
			<div class="box box-primary">
				<div class="box-header">
					<h3 class="box-title">Enter User Name & Password to Login</h3>
				</div>
				<!-- /.box-header -->
				<!-- form start -->
      ...
      <footer class="main-footer">
        ...
        <!--   <b>Version</b> 2.0 -->
         ...
         <strong>Copyright &copy; 2024-2025</strong> All rights reserved. 
      </footer>
    </div><!-- ./wrapper -->
